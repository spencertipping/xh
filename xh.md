...
[sec:double-precision-math] These functions are low-level and are
usually called by generated code rather than by hand. See
[chp:math-macro] for a macro that does this.
...
[part:xh-standard-library]

Function functions
==================

[chp:function-functions]
...
[chp:list-functions] The usual suspects.
