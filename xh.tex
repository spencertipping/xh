...
\newcommand{\refboth}[1]{\ref{#1} \ref{#1-original}}
...
\begin{enumerate}
\item{}\Label{is:evaluation-identities}{xhs.eval-identities}
...
\item{}\Label{is:relational-evaluation}{xhs.relational}
...
\end{itemize}
\item{}\Label{is:best-first-search}{xhs.bestfirst}
...
\end{itemize}
\item{}\Label{is:no-cut-operator}{xhs.nocut}
...
\item{}\Label{is:unquote-structure-preserving}{xhs.unquote-structure}
...
\item \refboth{i:not-slow} above)
\end{itemize}
\item{}\Label{is:stack-local-scoping}{xhs.stackscope}
...
\item \refboth{is:evaluation-identities}
\end{itemize}
\item{}\Label{is:no-variable-shadowing}{xhs.noshadow}
  Variable shadowing is impossible.
\begin{itemize}
\item \refboth{is:evaluation-identities}
\item \refboth{is:stack-local-scoping}
\end{itemize}
\item{}\Label{is:unquoting-vs-parsing}{xhs.unquote-parse}
...
\item{}\Label{is:runtime-as-receiver}{xhs.runtimereceiver}
...
\end{itemize}
\item{}\Label{is:function-variable-namespaces}{xhs.namespaces}
...
\end{itemize}
\item{}\Label{is:function-literals-as-messages}{xhs.fnliterals}
...
\item \refboth{is:runtime-as-receiver}
\end{itemize}
\item{}\Label{is:transient-definitions}{xhs.transientdefs}
...
\item \refboth{is:runtime-as-receiver}
\end{itemize}
\item{}\Label{is:global-definition-universality}{xhs.globaldefs}
...
\item{}\Label{is:macros-cannot-exist}{xhs.nomacros}
...
\item \refboth{is:unquote-structure-preserving}
\end{itemize}
\item{}\Label{is:errors-cannot-exist}{xhs.noerrors}
...
\begin{enumerate}
\item{}\Label{ir:priority-queue}{xhr.priorityqueue}
...
\item{}\Label{ir:static-inlining}{xhr.staticinline}
...
\item{}\Label{ir:expression-representation}{xhr.representation}
...
\item \refboth{is:evaluation-identities}
\end{itemize}
\item{}\Label{ir:flat-containers}{xhr.flatcontainers}
...
\item{}\Label{ir:hinting}{xhr.hinting}
