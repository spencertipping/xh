...
#dom   {margin: 20px 0}
#dom a {font-family:     'Abel', sans-serif;
...
<div id='dom'>
<a href='https://github.com/spencertipping/xh'>
  github.com/spencertipping/<span class='title'>xh</span></a>
</div>
_ \end{javascriptcode}
...
$(caterwaul(':all')(function () {
  ...
  -where [toggle(t = $(this).stop()) =
            cs /~animate/ {top:    v ? 0 : -h}
     -then- t  /~animate/ {height: v ? h : 0, opacity: +v}
...
\item{}\Label{ica:harvard-architecture}{ca.harvard}{\em\ref{ica:harvard-architecture}}
  ...
  level is backend-specific and machine generated.
\begin{itemize}
\item \initial
\item \refboth{i:compile-to-c}
\item \refboth{i:compile-to-perl}
