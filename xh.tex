...
\end{enumerate}
  ...
  quantify optimization in terms of data throughput rates:~the optimization
  ratio is the ultimate data size over the total data generated. Our goal is to
  maximize this, while minimizing the expected size of any given piece of data.
  This model is also helpful when designing backends, since it's
  bandwidth-focused rather than process-focused (doing it this way might make
  it easier to vectorize things).
