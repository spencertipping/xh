...
\end{verbatim}
    ...
    {\bf TODO:}~how does \verb|@| work? If it's a prefix operator that
    \verb|@|-tags its operand, then how are we doing string concatenation of
    paren values? (i.e.~how do we know when a word prefix is a tag or a string
    prefix?)
